...
export const BackgroundFour = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      (path4 as SVGPathElement).style.strokeDashoffset = (
        length4 - drawLength4
      ).toString();

      const drawLength5 = length5 * progress;
      (path5 as SVGPathElement).style.strokeDashoffset = (
        length5 - drawLength5
      ).toString();
