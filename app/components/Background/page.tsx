...
export const BackgroundOne = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const progress = Math.min(scrollYProgress.get() * 10, 1);
      ...
      (path2 as SVGPathElement).style.strokeDashoffset = (length2 - drawLength2).toString();

      const drawLength3 = length3 * progress;
      (path3 as SVGPathElement).style.strokeDashoffset = (length3 - drawLength3).toString();
  ...
  return (
    <div className="svg-background">
        <svg width="1054" height="1898" viewBox="0 0 1054 1898" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
...
export const BackgroundTwo = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const progress = Math.min((scrollPosition - 700) / 300, 1);
      const drawLength = length * progress;
      (path as SVGPathElement).style.strokeDashoffset = (length - drawLength).toString();
...
export const BackgroundThree = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const scrollPosition = scrollY.get();
      if (scrollPosition < 1800) return;

      const progress = Math.min((scrollPosition - 1400) / 300, 1);
      const drawLength = length * progress;
      (path as SVGPathElement).style.strokeDashoffset = (length - drawLength).toString();
  ...
  return (
    <div className="svg-background">
        <svg width="1054" height="1898" viewBox="0 0 1054 1898" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M363.088 1022.09C357.451 1007.12 325.675 1020.44 266.803 993.128C266.803 993.128 265.633 992.419 265.155 992.815C264.677 993.211 265.386 994.463 265.386 994.463C270.808 1004.53 302.585 1030.18 325.23 1027.31C237.12 1038.45 148.252 1054.88 59.4993 1062.12C49.1325 1062.98 23.6686 1064.44 27.789 1043.61C39.2436 985.629 55.7086 944.425 55.1152 895.393C55.0976 895.043 54.9553 894.711 54.7142 894.457C54.473 894.203 54.1488 894.044 53.8004 894.008C53.4519 893.972 53.1021 894.062 52.8142 894.262C52.5264 894.461 52.3195 894.757 52.231 895.096C43.3779 934.91 30.9954 973.856 15.2301 1011.47C8.52212 1029.6 -6.19584 1048.84 2.86898 1068.84C13.3347 1092.45 42.2927 1086.36 62.6638 1084.29C150.312 1074.73 238.06 1061.61 322.906 1036.97C307.397 1048.62 294.641 1068.38 292.58 1087.35C292.523 1087.92 292.686 1088.49 293.036 1088.94C293.386 1089.39 293.895 1089.69 294.459 1089.78C294.935 1089.84 295.42 1089.76 295.848 1089.55C296.276 1089.33 296.626 1088.98 296.849 1088.56C312.671 1058.84 367.654 1034.22 363.088 1022.09Z" 
            fill="#FFCA75"
            stroke="#FFCA75"
            strokeWidth="2"
            fillRule="evenodd"
            ...
            style={{ fillOpacity: 0, transition: 'stroke-dashoffset 0.1s ease' }}
          />
          <path d="M54.868 979.02C55.5653 983.949 54.8212 988.975 52.7255 993.491C52.6774 993.709 52.5444 993.9 52.3559 994.02C52.1673 994.141 51.9386 994.181 51.7201 994.133C51.5015 994.085 51.311 993.952 51.1905 993.764C51.0699 993.575 51.0292 993.347 51.0773 993.128C50.8344 988.268 51.5454 983.408 53.1704 978.822C53.2117 978.61 53.3316 978.422 53.5059 978.294C53.6803 978.167 53.8963 978.11 54.1108 978.135C54.3254 978.16 54.5226 978.265 54.663 978.429C54.8034 978.593 54.8766 978.804 54.868 979.02Z" 
            fill="#FFCA75"
            stroke="#FFCA75"
            strokeWidth="2"
            fillRule="evenodd"
            ...
            style={{ fillOpacity: 0, transition: 'stroke-dashoffset 0.1s ease' }}
          />
          <path d="M49.4622 1005.29C48.3085 1015.59 42.8696 1027.44 45.3088 1036.97C45.8773 1038.99 47.036 1040.79 48.6364 1042.15C50.2368 1043.51 52.2059 1044.35 54.2912 1044.58C75.5194 1047.29 97.6375 1044.58 119.014 1042.94C119.101 1042.92 119.191 1042.94 119.264 1042.99C119.337 1043.04 119.386 1043.12 119.401 1043.21C119.417 1043.29 119.397 1043.38 119.346 1043.46C119.295 1043.53 119.217 1043.58 119.129 1043.59C97.3903 1049.21 73.5581 1052.92 51.3575 1048.97C49.4683 1048.65 47.679 1047.9 46.1333 1046.77C44.5876 1045.64 43.3286 1044.16 42.4575 1042.46C37.1175 1031.6 45.2429 1016.7 48.77 1005.18C48.7853 1005.08 48.8364 1005 48.9121 1004.95C48.9878 1004.89 49.082 1004.87 49.1737 1004.89C49.2655 1004.9 49.3475 1004.95 49.4016 1005.03C49.4557 1005.11 49.4775 1005.2 49.4622 1005.29Z" 
            fill="#FFCA75"
            stroke="#FFCA75"
            strokeWidth="2"
            fillRule="evenodd"
...
export const BackgroundFour = () => {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const drawLength4 = length4 * progress;
      (path4 as SVGPathElement).style.strokeDashoffset = (length4 - drawLength4).toString();

      const drawLength5 = length5 * progress;
      (path5 as SVGPathElement).style.strokeDashoffset = (length5 - drawLength5).toString();
